...
const mockLearningData = {
  ...
  skillProgress: [
    ...
    { skillId: 'math-money-3', name: 'Math: Real World Problems with Money', currentLevel: 1, masteryPercentage: 23, questionsAnswered: 8, averageAccuracy: 75, timeSpent: 67, streak: 1, lastStudied: '2024-01-13', difficulty: 'beginner', trend: 'stable' }
  ] as SkillProgress[]
}
