            ...
            >
              ...
              <div className="flex gap-2 flex-wrap justify-center mt-2">
                ...
                : assignments[pair.target]?.map((coin, idx) => (
                  <span key={idx} className="px-2 py-1 bg-yellow-400 text-sm rounded-full text-white">
                  {coin}
                  </span>
                ))
                }
        ...
        <div className="flex flex-wrap gap-3">
          {options.map((option, idx) => (
            <div
              ...
              className="cursor-grab px-3 py-2 bg-white border rounded-lg shadow hover:bg-blue-50 text-gray-400"
            >
              {option}
            </div>
          ))}
